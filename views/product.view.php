        ...
        <div class="container">
            <div class="row align-items-stretch">
                ...
                <div class="col-md-2 form-group">
                    <input class="form-check-input checkbox" type="checkbox" name="id[]" value="<?=$list->ID; ?>">
                    <h4><?=$list->sku; ?></h4>
                    <h4><?=$list->name; ?></h4>
                    <h4><?=$list->price; ?> $</h4>
                    <h4>
                        <?=$list->type; ?>:
                        <?php if ($list->type == "Size") :?>
                            <?=$list->size; ?>MB
                        <?php elseif ($list->type == "Dimensions") :?>
                            <?=$list->height; ?>x<?=$list->width; ?>x<?=$list->length; ?>cm
                        <?php else :?>
                            <?=$list->weight; ?>Kg                     
                        <?php endif; ?>
                    </h4>
